...
In November 2019 user Jojo kamalu added a python calculation of projectile motion with air resistance. Since it is so well documented and gives correct results, I copied the code here. Another user had already converted it to Python 3.

You can use the notebook as well.
